...
\begin{exercise}\textbf{Exercise 1.5.4}
	Given that the notation used in the formulation of the exercise is not completely clear I must clarify that I will be using the distribution function as $F(x) = \mu((-\infty, x])$ with $x \in \mathbb{R}^2$ using the partial order for $\mathbb{R}^2$ defined previously in the book.
